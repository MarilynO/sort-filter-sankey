    ...
    return function(t) {
        ...
        t.exports = i.extend("Sankey", {
            ...
            initialize: function() {
                ...
                i.d3.sankey = s(), i.d3.path = i.d3.sankey.link(), i.d3.sankey.size([i.features.width - 100, i.features.height]), i.features.spread = !1, i.features.iterations = 32, i.features.nodeWidth = i.d3.sankey.nodeWidth(), i.features.nodePadding = i.d3.sankey.nodePadding(), i.features.alignLabel = "auto", i.layers.links = i.layers.base.append("g").classed("links", !0), i.layers.nodes = i.layers.base.append("g").classed("nodes", !0), i.on("change:sizes", function() {
                    ...
                    insert: function() {
                        return this.append("path").classed("link", !0).attr('opacity', 0)
                    },
                    events: {
                        enter: function() {
                        ...
                        merge: function() {
                            this.attr('opacity', 0).transition().duration(1500).delay(1000).attr('opacity', 1).attr("d", i.d3.path).style("stroke", n).style("stroke-width", function(t) {
                    ...
                    events: {
                        enter: function() {
                          this.append("rect"), this.append("text").attr("dy", ".35em").attr("transform", null)
                          // this.on("click", function(t) {
                          //
                          // })
                            // this.append("rect"), this.append("text").attr("dy", ".35em").attr("transform", null), this.on("mouseover", function(t) {
                            //     i.trigger("node:mouseover", t)
                            // }), this.on("mouseout", function(t) {
                            //     i.trigger("node:mouseout", t)
                            // }), this.on("click", function(t) {
                            //     i.trigger("node:click", t)
                            // })
                        },
                        merge: function() {
                            this.style('opacity', 0).transition().duration(2000).style('opacity', 1).attr("transform", function(t) {
                                if (xVals.indexOf(t.x) == -1) {
                                  xVals.push(t.x);
                                }
                                return "translate(" + t.x + "," + t.y + ")"
                            }), this.select("rect").attr("height", function(t) {
                                return t.dy
                            }).attr("width", i.features.nodeWidth).style("fill", e).style("stroke", function(t) {
                                return r.rgb(e(t)).darker(2)
                            }), this.select("text").text(i.features.name).attr("y", function(t) {
                                return t.dy / 2
                            }).attr("x", function(e) {
                                return "start" === t(e) ? 6 + i.features.nodeWidth : -6
                              }).attr("text-anchor", t)
                        },
                        exit: function() {
                            this.remove()
            ...
            function o(t) {
                ...
                function i() {
                    a.forEach(function(t) {
                        var e, n, r, s = 0,
                            i = t.length;
                        for (t.sort(o), r = 0; i > r; ++r) e = t[r], n = s - e.y, n > 0 && (e.y += n), s = e.y + e.dy + d;
                        if (n = s - d - l[1], n > 0)
        ...
        t.exports = s("Sankey.Base", {
            initialize: function() {
                ...
                console.log(t.base.node().parentNode.clientWidth);
                t.features = {}, t.d3 = {}, t.layers = {}, t.features.margins = {
                    top: 50,
                    right: 1,
                    bottom: 6,
                    left: 1
                }, t.base.attr('viewBox', '0 0 ' + t.base.node().parentNode.clientWidth + ' ' + t.base.node().parentNode.clientHeight).attr('preserveAspectRatio', 'xMinYMin meet'),
                t.base.attr('width', t.base.node().parentNode.clientWidth),
                t.base.attr('height', t.base.node().parentNode.clientHeight)
...
});//# sourceMappingURL=d3.chart.sankey.min.map
